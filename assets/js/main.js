(function () {
    ...
    const translations = {
        de: {
            ...
            'start.heroIntro': 'Software Engineer aus dem Kanton Basel-Landschaft mit einem Herz für clevere Automatisierungen und nutzerzentrierte Lösungen. Bei Schneider &amp; Cie. AG in Basel verbinde ich unterschiedliche Systeme zu robusten Kundenportalen, Schnittstellen und smarten Prozessen.',
            ...
            'start.contactIntro': 'Lass uns sprechen – egal ob zu spannenden Projekten, Automatisierungsideen oder einem Match auf dem Tennisplatz.',
        ...
        en: {
            ...
            'start.heroIntro': 'Software engineer from the canton of Basel-Landschaft with a heart for smart automation and user-centred solutions. At Schneider &amp; Cie. AG in Basel I connect different systems to create robust customer portals, integrations and streamlined processes.',
            ...
            'start.contactIntro': 'Let’s talk – about exciting projects, automation ideas or even a match on the tennis court.',
